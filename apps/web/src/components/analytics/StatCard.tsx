...
export function StatCard({
  ...
  return (
    <div
      className={`flex flex-col gap-1 rounded-xl border border-ink-200 bg-white p-4 shadow-card border-t-2 ${accent}`}
      data-testid={testId}
    >
...
export function StatCardSkeleton() {
  return (
    <div className="flex flex-col gap-2 rounded-xl border border-ink-200 bg-white p-4 shadow-card border-t-2 border-t-ink-200">
