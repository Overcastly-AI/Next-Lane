/**
 * Inline SVG icon set for the sidebar's personal-section rows.
 *
 * Matches the existing header/ProjectNav icon vocabulary: 2px stroke,
 * 24-unit viewBox, no fill, monochrome (currentColor) — no icon-library
 * dependency, no multi-color icon set. Kept deliberately plain so the
 * sidebar's one accent (the active-row rail tick, see `AppSidebar.tsx`)
 * stays the only bold thing on the surface.
 */
export function MyWorkIcon({ className }: { className?: string }) {
  return (
...
export function MyBoardIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
/** Collapse/expand rail chevron — rotates via the caller's className. */
export function RailChevronIcon({ className }: { className?: string }) {
  return (
...
/** System (OS-follows) — a simple monitor glyph. */
export function SystemThemeIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
