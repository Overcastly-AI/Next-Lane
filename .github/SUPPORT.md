...
> https://github.com/Overcastly-AI/Next-Lane/discussions

## Where to report bugs

Use **GitHub Issues** for confirmed bugs — please use the bug report form so we
can reproduce the problem quickly. Check the existing issues first to avoid
duplicates.

> https://github.com/Overcastly-AI/Next-Lane/issues/new/choose
...
See [SECURITY.md](../SECURITY.md) for our full disclosure process and scope.
