...
- ⬜ **Parity-gap backlog** (from the Pass-6 audit): swimlanes, bulk edit, workflow transitions + validators, components, versions/releases, import/export, per-assignee workload report, configurable dashboards, project-level role overrides.
