...
After the security batch clears, the build order is: SMTP wiring (S) → WATCHED_UPDATED emission (S) → full-text search (M, P1) → public share link (M, P2) → presence indicators + remaining P2s.
