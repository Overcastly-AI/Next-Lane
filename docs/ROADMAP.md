...
- ⬜ **Conditional card colors** — per-board ordered rule list (NLQL condition → color, first match wins) with a legend. Backend color-rule query validation already wired in `updateBoard`.
