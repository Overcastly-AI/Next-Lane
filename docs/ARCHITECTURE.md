...
- **Model Context Protocol** server (stdio transport) with **117 tools** (54 read, 63 write — Pages pillar added 12 tools for CRUD, version history, and knowledge-graph traversal).
