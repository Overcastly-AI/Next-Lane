...
- **Model Context Protocol** server (stdio transport) with **124 tools** (60 read, 64 write — Pages pillar added 12 tools for CRUD, version history, and knowledge-graph traversal).
