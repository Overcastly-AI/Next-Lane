...
features:
  ...
  - icon: "🤖"
    ...
    details: >
      Built for the agent era. MCP-native today — 130 tools let AI coding agents
...
| **MCP agent integration — 130 tools + per-project agent memory, incl. agent-traversable page graph** | **Live** |
