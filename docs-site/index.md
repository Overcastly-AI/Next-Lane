...
features:
  ...
  - icon: "🤖"
    ...
    details: >
      Built for the agent era. MCP-native today — 126 tools let AI coding agents
...
| **MCP agent integration — 126 tools + per-project agent memory, incl. agent-traversable page graph** | **Live** |
